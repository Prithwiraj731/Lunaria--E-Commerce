...
function TryOn() {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                // Show ALL products as requested
                // Only filter out ones without images to prevent UI errors
                const allProducts = res.data.products || [];
                const validProducts = allProducts.filter(p => p.image);
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            // Create FormData with user image and garment URL
            ...
            // Call backend API with extended timeout (60 seconds for Gemini)
            ...
            setError(
                ...
                err.message ||
                "Error generating try-on. Please try again."
            );
        } finally {
            setGenerating(false);
        }
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                            ...
                            {loadingProducts ? (
                                ...
                                <div className="grid grid-cols-3 sm:grid-cols-4 gap-4 max-h-[600px] overflow-y-auto p-2 scrollbar-thin">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 flex flex-col items-center justify-center min-h-[600px] relative overflow-hidden">
                        ...
                        {resultImage ? (
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="text-xl font-bold text-dark animate-pulse">Gemini AI is creating your look...</h3>
                                <p className="text-gray-500 mt-2 max-w-xs mx-auto">Google's Nano Banana is generating your virtual try-on. This may take 15-30 seconds.</p>
                            </div>
                        ) : (
