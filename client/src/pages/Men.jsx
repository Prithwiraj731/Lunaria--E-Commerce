  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        // Filter products for men's category - Allow 'men', 'man', 'male' case-insensitive
        const menProducts = res.data.products.filter(product => {
          return product.category && ['men', 'man', 'male'].includes(product.category.trim().toLowerCase());
        });
    ...
    <div className="min-h-screen bg-gray-950 text-white font-sans transition-all duration-500 overflow-hidden">
      ...
      <section className="py-24 px-6 text-center relative overflow-hidden bg-gray-950">
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold tracking-wide drop-shadow-xl">
          <span className="bg-gradient-to-r from-fuchsia-400 to-indigo-500 text-transparent bg-clip-text">Men's</span> Collection
        </h1>
        <p className="mt-6 text-xl text-gray-300 max-w-2xl mx-auto">
          Discover sophisticated fashion pieces designed for the modern man.
        </p>
      </section>
      ...
      <section className="py-20 px-6 bg-gray-900 max-w-screen-xl mx-auto rounded-xl">
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <h3 className="text-2xl font-semibold mb-4">No Men's Products Found</h3>
